...
Helper functions for the creation of metadata for spatialRaster) currently are
built on an earlier version of ropensci/eml and not functional (these will be
updated soon (2018-12-17)), but generating spatialVectors (output to kml) is
supported.
