...
A EML object of type otherEntity can be created from a single file or a directory. As with all objects created with the capeml package, the resulting object is named with the `projectid_object-name_md5sum-hash.file extension` convention. In the case of generating a otherEntity object from a directory, a zipped file of the directory is created.
...
```{r sampleKeywordFile, eval=FALSE}
