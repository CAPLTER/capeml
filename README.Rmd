...
scope and number is generated and a `config.yaml`. In `config.yaml`, the
package number and package identifier are generated as parameters. New projects
assume a version number = 1, from which the package identifier (as
`packageIdent`) is generated in `config.yaml`.
