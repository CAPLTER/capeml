...
Please see the vignette, [](https://github.com/CAPLTER/capeml/blob/master/vignettes/create_spatialRaster.Rmd) for more information about creating EML for raster data.
