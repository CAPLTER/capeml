...
using the ropensci/eml are currently supported. Helper functions for the
creation of metadata for spatial data (e.g., spatialRaster) currently are built
on an earlier version of ropensci/eml and not functional - these will be updated
soon (2018-12-17). Note that the creation of people-related entities in EML are
specific to functions that rely on Global Institute of Sustainability
infrastructure - these tools are located in the
[gioseml](https://github.com/CAPLTER/gioseml) package.
...
* [dataSet elements: keywords, taxonomic coverage](https://github.com/CAPLTER/capeml#dataSet)
...
4. baseURL = (optional) The base path of the web-accessible location of the data
...
directory. As with all objects created with the capeml package, the resulting
object is named with convention: projectid_object-name_md5sum-hash.file
extension. In the case of generating a otherEntity object from a directory, a
zipped file of the directory is created.
...
employs a forked, feature branch of taxonomyCleanr
(https://github.com/CAPLTER/taxonomyCleanr/tree/taxonomy-rEML2) until EDI adapts
taxonmyCleanr to ropensci EML v2.
...
Please see the
[create_spatialRaster](https://github.com/CAPLTER/capeml/blob/master/vignettes/create_spatialRaster.Rmd)
