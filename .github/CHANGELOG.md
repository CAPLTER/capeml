...
## 2026-07-24
- Move the WAF reference material from pkgdown's generated `docs/` destination
  to `.github/ai-reference/waf/` so clean website builds cannot remove it.
- Update AI instruction paths to the new version-controlled location.
...
- Initial scaffold: lightweight `copilot-instructions.md` (think-then-code
  ...
  instructions, `well-architected` instruction, and WAF pillar checklists.
