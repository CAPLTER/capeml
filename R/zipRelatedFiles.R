...
#'
#' @description the zipped file name for inclusion in the EML documentation is
#'   returned. Side effects include all relevant files zipped into a single,
#'   compressed file named as: projectid + basefile name + md5sum + extension
#'   (zip).
#'
...
#'   extension (zip).
#'
#' @param targetFile a spatial data file
#'
#' @importFrom utils zip
#' @importFrom stringr str_extract
#' @importFrom tools md5sum
#'
#' @return the zipped file name for inclusion in the EML documentation
#'
#' @export
